			...
			<div class="main-slider-img-text slide-type-two pera-content headline position-relative">
				...
				<div class="container owl-slider-height">
					<div class="slider-content-box text-center">
						...
						<p>Provides end-to-end quality services for domestic or commercial or industrial clients.
						</p>
						<!-- <div class="slide-btn-1">
	...
	<section id="features" class="features-section position-relative" data-background="assets/img/background/ft-bg.jpg">
		...
		<div class="container">
			<div class="section-title-middle text-center">
				<h2>Jai solar provides end-to-end quality services</h2>
			</div>
			<!-- /title -->
		...
		<div class="container">
			<div class="section-title-middle text-center">
				<span class="title-tag">
					Helps For The Clean Energy Revolution
				</span>
				<h2>Reasons To Choose Jaysolar</h2>
			</div>
			<!-- /title -->
